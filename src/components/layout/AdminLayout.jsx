        ...
        <Navbar fluid rounded style={{backgroundColor:"paleturquoise"}}>
          ...
          <div className="flex md:order-2">
            <Dropdown
              ...
              inline
              label={
                <Avatar alt="User settings" img="https://lh3.googleusercontent.com/a/ACg8ocJ7vc3Dq9q8iTeEqi_5WMXkzq-YHtjpxs3F89ZViWDd-Ls=s192-c-rg-br100" rounded />
              }
            >
              <Dropdown.Header>
                <span className="block text-sm">Leo DoCa</span>
                <span className="block truncate text-sm font-medium">Anett@gmail.com</span>
              </Dropdown.Header>
